...
const CreateDonationCampaignForm = () => {
    ...
    const onSubmit = async (data) => {
        ...
        const response = await axiosSecure.post('/donation-campaign', petInfo)
        ...
        <div className="my-6 md:my-8 lg:my-12 xl:my-16 px-4 md:px-6 lg:px-12 xl:px-24">
            <div className="bg-gray-100 rounded-lg p-4 md:p-6 lg:p-8 space-y-4">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 w-full grid grid-cols-1 md:grid-cols-2 gap-3">
                    <h3 className="text-xl md:col-span-2 lg:text-2xl font-semibold text-center mb-4 md:mb-6">Create Donation Campaign</h3>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" id="maximumDonationAmount" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="1000"
                    ...
                    <div>
                        ...
                        <input type="date" id="lastDateOfDonation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="yyyy-mm-dd"
