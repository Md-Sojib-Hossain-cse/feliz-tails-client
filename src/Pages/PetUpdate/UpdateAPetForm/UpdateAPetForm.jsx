...
const UpdateAPetForm = () => {
    const { _id , name , photo , age , category , location , shortDescription , longDescription} = useLoaderData();
    ...
    const onSubmit = async (data) => {
        ...
        const photoUrl = res.data.data.url || photo;
        const name = data?.petName;
        const age = data?.age;
        const category = selectedOption?.value || category;
        ...
        const response = await axiosSecure.put(`/update-a-pet/${_id}`, petInfo)
            ...
            <div className="bg-gray-100 rounded-lg p-4 md:p-6 lg:p-8 space-y-4">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 w-full grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <input type="file" id="photo" defaultValue={photo} className="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input type="text" id="petName" defaultValue={name} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Pet Name"
                    ...
                    <div className="mb-6 md:col-span-2">
                        ...
                        <textarea name="shortDescription" id="shortDescription" placeholder="small note from the pet owner" defaultValue={shortDescription} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" {...register("shortDescription", { required: true })}></textarea>
